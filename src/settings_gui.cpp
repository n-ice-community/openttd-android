...
struct GameOptionsWindow : Window {
	...
	void DrawWidget(const Rect &r, WidgetID widget) const override
	{
		switch (widget) {
			...
			case WID_GO_GUI_BUTTON_RATIO:
				DrawSliderWidget(r, GAME_OPTIONS_BACKGROUND, GAME_OPTIONS_BUTTON, TC_BLACK, MIN_INTERFACE_SCALE, MAX_INTERFACE_SCALE, SCALE_NMARKS, this->button_ratio, ScaleMarkFunc);
				break;
	...
	{
		this->SetWidgetsLoweredState(false, WID_GO_TAB_GENERAL, WID_GO_TAB_INTERFACE, WID_GO_TAB_FONTS, WID_GO_TAB_GRAPHICS, WID_GO_TAB_SOUND, WID_GO_TAB_ADVANCED, WID_GO_TAB_SOCIAL);
		...
		switch (widget) {
			...
			case WID_GO_TAB_INTERFACE: plane = 1; break;
			case WID_GO_TAB_FONTS: plane = 2; break;
			case WID_GO_TAB_GRAPHICS: plane = 3; break;
			case WID_GO_TAB_SOUND: plane = 4; break;
			case WID_GO_TAB_SOCIAL: plane = 5; break;
			case WID_GO_TAB_ADVANCED: plane = 6; break;
			default: NOT_REACHED();
		}
